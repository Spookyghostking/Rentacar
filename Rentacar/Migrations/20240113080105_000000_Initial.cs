        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Value = table.Column<string>(type: "nvarchar(55)", maxLength: 55, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressOfResidence = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    LicencePlateNumber = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: false),
                    CodeName = table.Column<string>(type: "nvarchar(55)", maxLength: 55, nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Cars",
                columns: new[] { "ID", "CarBodyTypeID", "CarModelID", "CodeName", "DailyFee", "DateAdded", "FixedFee", "LicencePlateNumber", "ManufacturedYear", "SeatCount" },
                values: new object[,]
                {
                    { 1, 4, 1, "Billy", 30f, new DateTime(2024, 1, 13, 9, 1, 5, 45, DateTimeKind.Local).AddTicks(2384), 30f, "HB1840BS", 2002, 5 },
                    { 2, 4, 2, "Sam", 30f, new DateTime(2024, 1, 13, 9, 1, 5, 45, DateTimeKind.Local).AddTicks(2429), 30f, "70UGHC4R", 2008, 5 },
                    { 3, 6, 3, "Sean", 30f, new DateTime(2024, 1, 13, 9, 1, 5, 45, DateTimeKind.Local).AddTicks(2431), 30f, "CR055", 2010, 5 },
                    { 4, 4, 4, "Henry", 30f, new DateTime(2024, 1, 13, 9, 1, 5, 45, DateTimeKind.Local).AddTicks(2433), 30f, "S4D801", 1996, 5 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "/img/Car/Test.png" },
                    { 2, 2, "/img/Car/cor.jpg" },
                    { 3, 3, "/img/Car/Cross1.jpg" },
                    { 4, 3, "/img/Car/Cross2.jpg" },
                    { 5, 4, "/img/Car/Sierra.jpg" }
                });
