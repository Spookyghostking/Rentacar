...
{
    /// <inheritdoc />
    public partial class Initial_000000 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 4, 1, "Billy", 30f, new DateTime(2024, 1, 13, 6, 9, 39, 914, DateTimeKind.Local).AddTicks(6477), 30f, "HB1840BS", 2002, 5 },
                    { 2, 4, 2, "Sam", 30f, new DateTime(2024, 1, 13, 6, 9, 39, 914, DateTimeKind.Local).AddTicks(6520), 30f, "70UGHC4R", 2008, 5 },
                    { 3, 6, 3, "Sean", 30f, new DateTime(2024, 1, 13, 6, 9, 39, 914, DateTimeKind.Local).AddTicks(6522), 30f, "CR055", 2010, 5 },
                    { 4, 4, 4, "Henry", 30f, new DateTime(2024, 1, 13, 6, 9, 39, 914, DateTimeKind.Local).AddTicks(6525), 30f, "S4D801", 1996, 5 }
                });
