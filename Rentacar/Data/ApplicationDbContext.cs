...
namespace Rentacar.Data
{
    public class ApplicationDbContext : IdentityDbContext<IdentityUser>
    {
        ...
        //public DbSet<CarCategoryDataModel> CarCategories { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<CarDataModel>()
                .HasData(new List<object>() {
                    new { ID = 1, CodeName = "Billy", LicencePlateNumber = "HB1840BS", CarModelID = 1, CarCategoryID = 1, ManufacturedYear = 2002, DailyFee = 30.0f, FixedFee = 30.0f, DateAdded = DateTime.Now },
                    new { ID = 2, CodeName = "Sam", LicencePlateNumber = "70UGHC4R", CarModelID = 2, CarCategoryID = 1, ManufacturedYear = 2008, DailyFee = 30.0f, FixedFee = 30.0f, DateAdded = DateTime.Now },
                    new { ID = 3, CodeName = "Sean", LicencePlateNumber = "CR055", CarModelID = 3, CarCategoryID = 1, ManufacturedYear = 2010, DailyFee = 30.0f, FixedFee = 30.0f, DateAdded = DateTime.Now },
                    new { ID = 4, CodeName = "Henry", LicencePlateNumber = "S4D801", CarModelID = 4, CarCategoryID = 1, ManufacturedYear = 1996, DailyFee = 30.0f, FixedFee = 30.0f, DateAdded = DateTime.Now },
                });
            ...
            //builder.Entity<CarCategoryDataModel>()
            //    .HasData(new List<object>()
            //    {
            //        new { ID = 1, BodyTypeID = 4, Value = "A", DailyFee = 30.0f, FixedFee = 30.0f },
            //    });
